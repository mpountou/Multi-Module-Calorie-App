...
import com.intelligent.feature_onboarding_ui.screens.age.AgeViewModel.NavigationAction.*
    ...
    LaunchedEffect(key1 = Unit) {
        viewModel.navigationAction.collect { navigationAction ->
            when (navigationAction) {
                ...
                is ShowError -> {
                    viewModel.error = navigationAction.errorMessage?.let { context.getString(it) }.orEmpty()
                }
                else -> Unit
            }
        }
